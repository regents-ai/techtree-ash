defmodule TechtreeWeb.ResearchContent do
  @moduledoc """
  The embedded explanation of Techtree's controlled-comparison method, proof
  ...
  def sections(assigns) do
    ...
    <section id="research-start" class="doc-section">
