defmodule TechtreeWeb.PublicationRate do
  ...
  often as anybody likes. The two addresses that accept something are not, so
  they are counted together, and a caller over the limit is told to come back —
  with the number of seconds until they may, because a refusal that does not
