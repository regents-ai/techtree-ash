defmodule TechtreeWeb.DocsLive do
  ...
  def render(assigns) do
    ...
    Skill v1 → Skill v2</code></pre>
            <p>
              Prime Intellect’s
              <a href="https://github.com/PrimeIntellect-ai/verifiers?utm_source=chatgpt.com">
                verifiers
              </a>
          ...
          <section id="proof-bundle" class="doc-section">
            ...
            <ul class="doc-list">
              ...
              <li>the result names a published Campaign;</li>
          ...
          <section id="trust-boundary" class="doc-section">
            ...
            <ul class="doc-list">
              ...
              <li>the result generalizes beyond this Campaign;</li>
    ...
    → compare which environment produces
      the best downstream improvement</code></pre>
          ...
          <section id="agent-stack" class="doc-section">
            ...
            <p>
              <a href="https://github.com/NVIDIA/NeMo-Fabric?utm_source=chatgpt.com">
                NVIDIA NeMo Fabric
              </a>
              will help run different agent harnesses through a common interface.
              <a href="https://github.com/NVIDIA/NeMo-Relay?utm_source=chatgpt.com">NeMo Relay</a>
    ...
    study and proof compatibility</code></pre>
          ...
          <section id="regents" class="doc-section">
            ...
            <p>
              Future proofs, Skills, environments, harness improvements, and reproductions may be
          ...
          <section id="start" class="doc-section">
            ...
            <p>
              Go to <a href="https://techtree.sh/start">techtree.sh/start</a>, install the pinned
              Techtree release, and run the Hello World Climb. Stop before any paid model call and
              ask me to approve it.
            </p>
            <p>
              <a href="https://techtree.sh/start">Start with Techtree</a>
              · <a href="https://techtree.sh/results">Browse published proofs</a>
            </p>
          </section>
          ...
          <section id="verifier-checks" class="doc-section">
            ...
            <ol class="docs-numbered-list">
              ...
              <li>The named Campaign is one published by this site.</li>
              <li>Wins, losses, and ties recompute from the task results.</li>
              <li>The tasks and their order match the Campaign commitment.</li>
              <li>The Campaign’s policy permits publication.</li>
